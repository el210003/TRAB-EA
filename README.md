...
**M1 Expert Advisor for MetaTrader 5** · Version 1.10
...
2. Compile in MetaEditor (**F7**) — or use the prebuilt `TRAB_EA.ex5` (v1.10, compiled 0 errors / 0 warnings).
...
├── TRAB_EA.ex5                     # Prebuilt v1.10 (drop into MQL5\Experts)
├── docs/
